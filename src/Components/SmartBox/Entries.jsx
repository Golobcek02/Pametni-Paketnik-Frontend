    ...
    return (
        <div className="entries-container">
            {entries.length !== 0 ? (
                    ...
                    <div className="card" key={entry.id}>
                        <div className="card-top-part">
                            ...
                            <div className="right-part">
                                <div className="user-photo">
                                    {entry.EntryType === "boxOpening" ? (
                                        <img src="/green.jpg" className="photo" alt="Green"/>
                                    ) : entry.EntryType === "boxDeleted" ? (
                        ...
                        <div className="card-bottom-part">
                            <div className="bottom-part">
                                <a onClick={() => deleteEntry(entry.ID)} className="link" style={{color: "#DF2E38"}}>
                                    Delete
                                </a>
                            </div>
                        </div>
                ...
                <div className="no-entries">YOU HAVE NO ENTRIES</div>
            )}
        </div>
    );
}
